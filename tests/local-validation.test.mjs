...
assert.ok(requestedGoldStorePackageReview.bodyLength >= 1800 && requestedGoldStorePackageReview.bodyLength <= 2500);
...
assert.ok(requestedFamilyCafePackageReview.bodyLength >= 1800 && requestedFamilyCafePackageReview.bodyLength <= 2500);
...
assert.ok(requestedDryShampooPackageReview.bodyLength >= 1800 && requestedDryShampooPackageReview.bodyLength <= 2500);
