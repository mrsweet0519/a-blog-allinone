...
export const softenForTone = (value = "", tone = "") => {
  ...
  return source
    .replace(/확인할 필요가 있습니다/g, "미리 확인해두면 훨씬 편했어요")
    .replace(/확인이 필요합니다/g, "한 번 확인해보면 좋겠어요")
    .replace(/확인할 수 있습니다/g, "확인해볼 수 있어요")
    .replace(/도움이 됩니다/g, "도움이 되더라고요")
    .replace(/권장됩니다/g, "챙겨보면 좋겠어요")
    .replace(/필요합니다/g, "챙겨보면 좋겠어요")
    .replace(/하는 것이 중요합니다/g, "해보고 고르는 게 좋겠더라고요")
    .replace(/하는 것이 좋습니다/g, "해보면 좋겠어요")
    .replace(/보는 것이 좋습니다/g, "보면 좋겠어요")
